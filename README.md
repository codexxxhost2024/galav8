...
<div align="center">
  <h1>GALA Clone with Nextjs 13</h1>
</div>
...
<div align='center'>
  GALA app clone with Next.js 13, that allows you to search for properties, add them to favorites, make reservations, login with Google, Github or Email, list your properties, and more.
...
- [x] Show a list of cards with properties like GALA
...
- [x] Has categories filters like GALA
